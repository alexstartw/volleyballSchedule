...
builder.Services.AddScoped<ITempPlayerListRepo, TempPlayerListRepo>();
builder.Services.AddScoped<ILineBotService, LineBotService>();
builder.Services.AddDbContext<PlayerContext>(options =>
{
    options.UseNpgsql("Host=192.168.1.162;Port=5432;Database=postgres;Username=postgres;Password=12345678;");
});
